...
const SheetPlate = () => {
    ...
    // const name = selectedCardData.name;
                    ...
                    <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, gap: 5}}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, flex: 1 }}>
                            <SelectInputField
                                ...
                                status={status}
                            />
                            <Box sx={{ display: "flex",mt:1, flexDirection: { xs: "column", sm: "row" }, gap: { xs: 0, sm: 1 } }}>
                                <TextField
                                    label="Thickness(mm)"
                                    variant="outlined"
                                    name="thickness"
                                ...
                                />
                                <Typography sx={{ mt: 1, ml: { xs: 20, sm: 0 }, fontSize: "20px" }}>x</Typography>
                                <TextField
                                    label="Width(mm)"
                                    variant="outlined"
                                    name="width_value"
                            ...
                            <SelectInputFields
                                ...
                                disabled={docStatus === 1 || status === "Withdrawn"}
                            />
                            <Box sx={{ display: "flex",mt:1, flexDirection: { xs: "row", sm: "row" }, gap: { xs: 1, sm: 1 } }}>
                                <InputField
                                    name="quantity"
                                    label="Quantity"
                                    type="text"
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, flex: 1 }}>
                            ...
                            <TextField
                                id="outlined-multiline-static"
                                label="Previous Submission (Read Only)"
                                multiline
                                disabled
