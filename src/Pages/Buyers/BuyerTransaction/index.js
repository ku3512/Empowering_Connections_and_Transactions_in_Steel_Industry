...
const BuyerTransaction = () => {
  ...
  <Typography sx={{ fontWeight: "bold", fontSize: 25,ml:2}}>Transaction History </Typography>
  ...
  {filteredData.length === 0 ? (
    <Typography sx={{ fontWeight: "bold", fontSize: 25, color: "#B8390E", textAlign: "center",mt:8 }}>Opps..! Transaction Not Found</Typography>
  ) : (
    <>
