...
const BuyerRequirement = () => {
  ...
  useEffect(() => {
    const fetchRequirementType = async () => {
      try {
        const response = await fetch(
          "https://steel.smartyerp.in/api/method/steel.api.get_requirement_type",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `token ${key}:${secret}`,
    ...
    const fetchCategoryType = async () => {
      try {
        const response = await fetch(
          "https://steel.smartyerp.in/api/method/steel.api.get_category",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `token ${key}:${secret}`,
    ...
    const fetchGradeType = async () => {
      try {
        const response = await fetch(
          "https://steel.smartyerp.in/api/method/steel.api.get_grade",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `token ${key}:${secret}`,
    ...
    const fetchStatus = async () => {
      try {
        const result = await fetch(
          "https://steel.smartyerp.in/api/method/steel.api.get_requirement_status",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `token ${key}:${secret}`,
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                          <Grid container spacing={2}>
                            ...
                            <Grid item xs={6} sm={6} sx={{ fontSize: 12 }}>
                              {format(
